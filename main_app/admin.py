...
from main_app.models.model_news.news import News, Comment, NewsType, NewsSubscriber
from main_app.models.model_picture.picture import Picture,CommentPicture

admin.site.register([Album,ComentAlbum,News,Comment,NewsType,Book,ComentBook,User,Picture,CommentPicture,ContactMessage,NewsSubscriber])
